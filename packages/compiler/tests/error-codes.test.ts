...
describe("error-code registry", () => {
  it("has an entry for every code the compiler currently emits", () => {
    ...
    for (const code of ["ALI001", "ALI002", "ALI003", "CAP001", "CAP002", "CAP003", "EFF002", "FMT001", "INT001", "INT002", "INT003", "INT004", "RES001", "SYN001", "UNS001", "UNS002", "UNS003", "UNS004", "UNS005"]) {
