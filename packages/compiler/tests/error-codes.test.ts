...
describe("error-code registry", () => {
  it("has an entry for every code the compiler currently emits", () => {
    ...
    const expected = [
      ...
      "FMT001",
      "INT001", "INT002", "INT003", "INT004", "INT005", "INT006", "INT007", "INT008", "INT009", "INT010", "INT011", "INT012", "INT013", "INT014", "INT015", "INT016", "INT017", "INT018", "INT019", "INT020", "INT021", "INT022", "INT023", "INT024", "INT025", "INT026", "INT027",
