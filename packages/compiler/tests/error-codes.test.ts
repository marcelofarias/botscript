...
describe("error-code registry", () => {
  it("has an entry for every code the compiler currently emits", () => {
    ...
    const expected = [
      ...
      "RES001", "RES002",
      "SYN001", "SYN002", "SYN003", "SYN004", "SYN005", "SYN006", "SYN007", "SYN008", "SYN009", "SYN010", "SYN011", "SYN012", "SYN013", "SYN014", "SYN015", "SYN016", "SYN017", "SYN018", "SYN019", "SYN020", "SYN021", "SYN022", "SYN023",
